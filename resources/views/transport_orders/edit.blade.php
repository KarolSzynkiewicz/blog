    ...
    <div class="flex flex-wrap -mx-3">
        ...
        <div class="flex flex-col h-full">
            <div class="flex justify-between">
                <div class="left"><h2 class="mb-0 font-bold dark:text-white">Edytuj Zlecenie Transportowe {{ $transportOrder->id  }}</h2></div>
                <div class="right"><x-button><a href="/orders">powrót</a></x-button>
              </div>
        </div>
        </div>
        </div>
        ...
        <input type="text" value = {{ $transportOrder->loading_date }} >
        ...
        <h5 class="mb-0  dark:text-white">
            <input type="date" value ={{ $transportOrder->unloading_date}}>
        ...
        <h5 class="mb-0  dark:text-white">
            <input type="text" value ={{ $transportOrder->loading_address }}>
        ...
        <h5 class="mb-0  dark:text-white">
            <input type="text" value ={{ $transportOrder->unloading_address }}>
        </h5>
        </div>
        </div>
        <div class="w-4/12 max-w-full px-3 text-right flex-0">
